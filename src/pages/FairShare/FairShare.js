...
const FairShare = () => {
  ...
  const handleSimulate = async (e) => {
    ...
    await Axios.get(
      `http://localhost:3001/api/fairShare/${from_value}/${to_value}/${cpu_weigth}/${memory_weigth}/${io_weight}/${dataset}`
    )
      .then((response) => {
  ...
  return (
    <div className="schedule-page-FS">
      ...
      <form className="schedule_form_FS" onSubmit={handleSimulate}>
        <label>
